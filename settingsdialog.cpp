...
**
** settingsdialog.cpp - reboundlinx software
**
...
{
    const qint32 constbaudrate = 9600;
    const QSerialPort::DataBits constdatabits = QSerialPort::Data8;
    const QSerialPort::Parity constparity = QSerialPort::NoParity;
    const QSerialPort::StopBits conststopbits = QSerialPort::OneStop;
    const QSerialPort::FlowControl constflowcontrol = QSerialPort::NoFlowControl;
...
/*    if (ui->baudRateBox->currentIndex() == 4) {
    ...
    currentSettings.baudRate = constbaudrate;
